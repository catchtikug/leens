# Generated by Django 5.2.1 on 2025-05-25 03:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('WORKER', 'Healthcare Worker')], default='WORKER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aware_of_allergy', models.BooleanField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
